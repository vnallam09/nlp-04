...
Run from root project folder with:
  ...
  uv run python -m nlp_teja.pipeline_api_json
"""
...
from nlp_teja.config_teja import (
    API_URL,
    DATA_PATH,
...
from nlp_teja.stage01_extract import run_extract
from nlp_teja.stage02_validate_teja import run_validate
from nlp_teja.stage03_transform_teja import run_transform
from nlp_teja.stage04_load import run_load
